...
-- CREATE SEQUENCE core.answer_id_seq INCREMENT BY 1;
-- COMMENT ON SEQUENCE core.answer_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.decision_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.decision_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.message_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.message_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.organisation_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.organisation_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.question_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.question_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.user_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.user_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.user_info_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.user_info_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.user_roles_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.user_roles_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.voter_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.voter_id_seq IS 'Autogenerated Sequence.';

CREATE SEQUENCE core.voting_id_seq INCREMENT BY 1;
COMMENT ON SEQUENCE core.voting_id_seq IS 'Autogenerated Sequence.';
...
(
  id BIGINT DEFAULT nextval('core.answer_id_seq'::regclass) NOT NULL,
...
/******************** Add Table: core.decision ************************/

/* Build Table Structure */
CREATE TABLE core.decision
(
  id BIGINT DEFAULT nextval('core.decision_id_seq'::regclass) NOT NULL,
...
/* Add Primary Key */
ALTER TABLE core.decision ADD CONSTRAINT pkdecision
PRIMARY KEY (id);

/* Add Comments */
COMMENT ON COLUMN core.decision.date_create IS 'Дата создания решения';

COMMENT ON COLUMN core.decision.voter_id IS 'ID голосующего';

COMMENT ON COLUMN core.decision.question_id IS 'ID вопроса';

COMMENT ON COLUMN core.decision.answer_id IS 'ID вопроса';

COMMENT ON COLUMN core.decision.score IS 'Количество баллов';

COMMENT ON TABLE core.decision IS 'Решение по вопросу';
...
(
  id BIGINT DEFAULT nextval('core.message_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.organisation_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.question_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.user_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.user_info_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.user_roles_id_seq'::regclass) NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.voter_id_seq'::regclass) NOT NULL,
  user_id BIGINT NOT NULL,
  voting_id BIGINT NOT NULL,
...
(
  id BIGINT DEFAULT nextval('core.voting_id_seq'::regclass) NOT NULL,
...
/* Add Foreign Key: fk_decision_answer */
ALTER TABLE core.decision ADD CONSTRAINT fk_decision_answer
FOREIGN KEY (answer_id) REFERENCES core.answer (id)
ON UPDATE NO ACTION ON DELETE NO ACTION;

/* Add Foreign Key: fk_decision_question */
ALTER TABLE core.decision ADD CONSTRAINT fk_decision_question
FOREIGN KEY (question_id) REFERENCES core.question (id)
ON UPDATE NO ACTION ON DELETE NO ACTION;

/* Add Foreign Key: fk_decision_voter */
ALTER TABLE core.decision ADD CONSTRAINT fk_decision_voter
FOREIGN KEY (voter_id) REFERENCES core.voter (id)
ON UPDATE NO ACTION ON DELETE NO ACTION;
